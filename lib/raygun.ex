defmodule Raygun do
  ...
  def environment do
    ...
    disk_free_spaces = for {mount_point, capacity, percent_used} <- disks do
  ...
  def details do
    ...
    %{
    		...
    		version: Application.get_env(:raygun, :version),
    		client: %{
    			name: Application.get_env(:raygun, :app),
    			version: Application.get_env(:raygun, :version),
    			clientUrl: Application.get_env(:raygun, :app)
    		}
    }
  end
